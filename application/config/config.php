...
// define('APPLICATION_NAME', 'VegeFoods');
// define('APPLICATION_URL', 'vegefoods.id');
// define('SITE_DELIMETER_MSG', 'Best regards,');
// define('SITE_DELIMETER', 'Admin');
// define('SALT', FALSE);

// define('TO_MAIL', 'info@vegefoods.id');
// define('FROM_MAIL', 'admin@vegefoods.id');
